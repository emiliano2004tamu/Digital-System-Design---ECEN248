...
##IO_L24N_T3_34
#set_property PACKAGE_PIN P16 [get_ports {North}]
#set_property IOSTANDARD LVCMOS33 [get_ports {North}]

set_property PACKAGE_PIN K19 [get_ports {farmSensor}] //farm sensor button
